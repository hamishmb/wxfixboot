    ...
    def SetNewBootloaderConfig(self, OS):
        ...
        if BootloaderInfo[OS]["Settings"]["NewBootloader"] in ("GRUB2", "GRUB-UEFI"):
            ...
            if BootloaderInfo[OS]["Settings"]["NewBootloader"] == "GRUB-UEFI":
                ...
                BootloaderConfigSettingTools.InstallGRUB2ToMBR(PackageManager=OSInfo[OS]["PackageManager"], UseChroot=UseChroot, MountPoint=MountPoint, Device=BootloaderInfo[OS]["BootDisk"])
            ...
            elif SystemInfo["FirmwareType"] == "UEFI" or (BootloaderInfo[OS]["Settings"]["NewBootloader"] == "GRUB2" and BootloaderInfo[OS]["Bootloader"] == "GRUB-UEFI"):
