...
#Begin Main Class.
class Main():
    def StartProcess(self, ExecCmds, ShowOutput=True, ReturnOutput=False): #*** ShowOutput is ignored currently *** *** Will also eventually replace MainBackendTools: Main().StartThreadProcess() ***
