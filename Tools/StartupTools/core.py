...
class Main():
    ...
    def HasWindows9X(self, MountPoint):
        ...
        return (os.path.isdir(MountPoint+"/WINDOWS") and os.path.isfile(MountPoint+"/AUTOEXEC.BAT") and os.path.isfile(MountPoint+"/COMMAND.COM") and os.path.isdir(MountPoint+"My Documents"))
