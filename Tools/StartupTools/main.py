    ...
    def GetBootloaders(self):
        ...
        for OS in Keys:
            ...
            if BootloaderInfo[OS]["Bootloader"] in ("GRUB-UEFI", "GRUB2") and os.path.isfile(MountPoint+"/etc/default/grub"):
                ...
                GRUBDir, BootloaderInfo[OS]["MenuEntries"] = BootloaderConfigObtainingTools.ParseGRUB2MenuData(MenuEntries=BootloaderInfo[OS]["MenuEntries"], MenuData="", MountPoint=MountPoint)[0:2]
